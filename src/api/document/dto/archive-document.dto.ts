...
export class ArchiveDocumentPaginationDTO {
    @ApiProperty({
        example: '10',
    })
    @IsNotEmpty()
...
export class ArchiveDocumentResDTOResDatas {
    @ApiProperty()
    id: string;
...
class ArchiveDocumentResDTOResData {
    @ApiProperty()
    totalItems: number;
    ...
    @ApiProperty({
        type: () => [ArchiveDocumentResDTOResDatas],
    })
    datas: ArchiveDocumentResDTOResDatas[];
}
export class ArchiveDocumentResDTO {
    @ApiProperty({
    ...
    @ApiProperty({
        type: () => ArchiveDocumentResDTOResData,
        description: 'ข้อมูล',
    })
    resData: ArchiveDocumentResDTOResData;
    ...
    constructor(
        ...
        const _resData = new ArchiveDocumentResDTOResData();
        ...
        if (!!data) {
            for (const item of data) {
                const _data = new ArchiveDocumentResDTOResDatas();
                _data.id = item.id;
